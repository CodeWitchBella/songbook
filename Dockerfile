...
# Make sure the .wasm files exist
COPY frontend/src/wasm/songbook-render-pdf ./frontend/src/wasm/songbook-render-pdf
COPY frontend/src/wasm/songbook-render-html ./frontend/src/wasm/songbook-render-html
