...
export default function Changelog() {
  return (
    <div>
      ...
      <Entry date="2020-06-12">
        <li>Instalační tlačítko přesunuto na domovskou obrazovku</li>
      </Entry>
      <Entry date="2020-06-08">
        <li>Další pokus o odstranění probliknutí chybové stránky při updatu</li>
        <li>
          Odstraněna separátní stránka pro PDF náhled jednotlivé písně (v
          editoru náhled stále je)
        </li>
        <li>Přidáno tlačítko zpět do editoru písní</li>
        <li>
          Opravena interakce tlačítka zpět a tlačítka výběru náhodné písně
        </li>
      </Entry>
      ...
      <Entry date="2020-05-30">
        <li>
          ...
          usnadní vydávání nových verzí, ale to bylo docela jednoduché i
          předtím, takže opět nuda.
        </li>
      </Entry>
      <Entry date="2020-03-17">
        <li>
          Zablokování zhasínání pokud je otevřena píseň. Funguje pouze v chrome
          a pouze dočasně, neboť používá experimentální funkci.
        </li>
      </Entry>
      ...
      <Entry date="2018-09-27">
        <li>
          Opraveno skrývání tlačítka &ldquo;Nainstalovat jako appku&rdquo;
        </li>
        <li>
